...
let varstored_chroot_path domid = Printf.sprintf "%s/varstored-chroot-%d" var_run_xen_path domid
let efivars_resume_path domid = (sprintf "%s/efi-vars-resume.dat") (varstored_chroot_path domid)
let efivars_save_path domid = (sprintf "%s/efi-vars-save.dat") (varstored_chroot_path domid)
